package net.tantonb.dimtest.dimensions.altover;
...
public class AltoverTeleporter implements ITeleporter {
    ...
    public AltoverTeleporter(BlockPos fromPos) {
    ...
    private void placeTeleporterInWorld(ServerWorld world, BlockPos pos) {
        BlockState teleporter = ModBlocks.ALTOVER_PORTAL.get().getDefaultState();
