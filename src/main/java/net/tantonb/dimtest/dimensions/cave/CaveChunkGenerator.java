...
public class CaveChunkGenerator extends ChunkGenerator {
    public static final Codec<CaveChunkGenerator> CODEC =
            RecordCodecBuilder.create(
                    instance -> instance.group(
                            BiomeProvider.CODEC.fieldOf("biome_source")
                                    .forGetter(ChunkGenerator::getBiomeProvider)
                    ).apply(instance, instance.stable(CaveChunkGenerator::new))
            );

    public CaveChunkGenerator(BiomeProvider biomeProvider) {
        super(biomeProvider,
    ...
    public static void register() {
        Registry.register(
                ...
                new ResourceLocation(DimTestMod.MODID, "testdim1_chunk_generator"),
                CODEC
        );
    }
